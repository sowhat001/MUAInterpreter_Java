...
public class FirstExecute extends OperExecute
{
    public FirstExecute(CmdExecute cmdExecute)
    {
        super(cmdExecute);
            ...
            else
            {
                if (d.toString().length() > 0)
                {
                    if (d.toString().charAt(0) == '"')
                    {
                        ...
                        {
                            newData = new Data(d.toString().substring(0, 2));
                        }
                        else
                        {
                            newData = new Data("\"");
                    ...
                    {
                        newData = new Data(d.toString().substring(0, 1));
                    }
                }
                else
                {

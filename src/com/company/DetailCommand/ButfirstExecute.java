...
public class ButfirstExecute extends OperExecute
{
    public ButfirstExecute(CmdExecute cmdExecute)
    {
        super(cmdExecute);
            ...
            else
            {
                if (d.toString().length() > 0)
                {
                    if (d.toString().charAt(0) == '"')
                    {
                        ...
                        {
                            newData = new Data(d.toString().substring(2));
                        }
                        else
                        {
                            newData = new Data("\"");
                    ...
                    {
                        newData = new Data(d.toString().substring(1));
                    }
                }
                else
                {
